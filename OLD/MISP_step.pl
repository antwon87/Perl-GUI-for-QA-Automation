...
# Open a "file handle" to the log string. This will allow me to print to the string.
open my $to_log, '>', \$log or die "Can't open \$to_log: $!";

# sub QA_Go {
    my $xml_raw = shift or die "ERROR: You must include the XML file exported from the MISP step as an argument.\n";    
    ...
    open(my $infile, '<', $xml_raw) or die "Couldn't open input XML file.\n";
    open(my $outfile, '>', $xml_trimmed) or die "Couldn't open file to output trimmed XML.\n";
